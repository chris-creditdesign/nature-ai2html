...
// Modified version of https://github.com/douglascrockford/JSON-js/blob/master/json2.js
...
const json2 = function (): JSONPolyfill {
  let JSON: JSONPolyfill = {};
  ...
  function str(key: string | number, holder: Record<string, any>): string {
    // Produce a string from holder[key].
    var i; // The loop counter.
    var k; // The member key.
    var v; // The member value.
    var length: string | number;
    var mind = gap;
    var partial;
  ...
  if (typeof JSON.parse !== "function") {
    JSON.parse = function (
      ...
      function walk(holder: Record<string, any>, key: string) {
